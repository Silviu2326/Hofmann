...
export const VideoHero: React.FC = () => {
  ...
  const scrollToContent = () => {
    const contentSection = document.getElementById('album-content');
    if (contentSection) {
  ...
  return (
    <div className="relative h-[85vh] overflow-hidden">
      <video
        ...
        poster="https://images.unsplash.com/photo-1522673607200-164d1b6ce486?auto=format&fit=crop&q=80&w=2000"
      >
        <source
          src="https://www.hofmann.es/content/photobook/banner-video/banner-video-ES.mp4"
          type="video/mp4"
        />
      </video>
      ...
      <div className="relative h-full flex flex-col items-center justify-center text-center text-white px-4">
        <span className="text-rose-400 text-lg font-medium mb-4">Álbumes de fotos personalizados</span>
        <h1 className="text-5xl md:text-7xl font-bold mb-6 max-w-4xl leading-tight">
          Tus recuerdos merecen un álbum excepcional
        </h1>
        <p className="text-xl md:text-2xl mb-8 max-w-2xl text-gray-200">
          Crea un álbum de fotos único con nuestro editor intuitivo y acabados premium
        </p>
